  ...
  @else
    ...
    <table class="ui attached single line definition table portal-table" id="applications-table" >
      <thead>
        <tr>
          <th></th>
          <th class="one wide">Reference No</th>
          <th class="five wide">Licence Name</th>
          <th class="five wide">Date Submitted</th> 
          <th class="five wide">Date Renewed</th>
      ...
      <tbody>
        @foreach($applications as $application)
          ...
          -->
            <!-- <td>
              <a href="{{route('view.renewal', [ 'id' => $application->ServiceHeaderID ])}}">
            ...
            <td>{{ \Carbon\Carbon::createFromTimeStamp(strtotime($application->LicenceRenewalDate))->toFormattedDateString() }}</td>
