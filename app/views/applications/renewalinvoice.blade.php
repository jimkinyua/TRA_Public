    ...
    <div class="ui basic segment">
        ...
        <div class="ui two column centered grid">
            ...
            <div class="ui right aligned column">
                ...
                <div>Issued On: {{ \Carbon\Carbon::createFromTimeStamp(strtotime($invoice->InvoiceDate))->toFormattedDateString() }}</div>
                <div class="inv-col"><span>Total Due : </span> {{number_format($invoice->balance(), 2)}}</div>
            </div>
        </div>
    </div>
      ...
      <div class="ui grid">
        ...
        <div class="row">
          ...
          <button> Confirm Payment </button> </a> -->
			  <a href="{{route('application.licencerenewalinvoicepdf', [ 'hid' => $invoice->id()])}}"><button>View As Pdf</button></a> </td>			  
          </div>
          </div>
        </div>
