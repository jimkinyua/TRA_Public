        ...
        $( document ).ready(function() {
            ...
            if(fid == 12) { //form id 12 is land registration
              ...
              $('#previous').change(function() {
                console.log('what im to do...', $('.ui.checkbox').checkbox('is checked'));
                ...
                $.get(endpoint, function( data ) {
                  ...
                  if(res.status == 'done') {
                    ...
                    var message = " \
                      ...
                      "</tbody> </table>" + "<br/>" +
                      "<button class='mini left floated ui primary button' id='confirm'> Correct </button> " +
                      "<button class='mini right floated ui button' id='reject'> Incorrect </button> " + "<br/>" +
                      "</p> </div> </div> \
                    ";
                  } else {
                    var message = " \
