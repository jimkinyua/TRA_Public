<html>
	...
	<body>
		...
		<div id="window">
			<div class="ui attached segment three column divided grid">
		    <div class="equal height row">

	        <div id="bill-left" class="three wide column">
						@yield('bill-left')
	        </div>

	        <div id="bill-content" class="nine wide column">
            @yield('bill-content')
	        </div>

	        <div id="bill-right" class="four wide column">
						@yield('bill-right')
	        </div>
