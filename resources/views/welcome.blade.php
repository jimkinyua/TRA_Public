	  ...
	  <div id="window">
		    ...
		    <div class="equal height row">
		        ...
		        <div id="feature" class="ten wide column" style=" overflow-y: auto;">
						    ...
						    <p>
								The County Government of Uasin Gishu is constantly improving its service delivery to citizens and
								the business community. E-services portal is your one-stop-shop to make dealing with the county easy.
								Services are available 24 7 and throughout the week. You do not need to visit the county for your services.
							</p>
						    <p>
									...
									<div class="ui list">
										<a class="item">
											...
											<div class="content">
												...
												<div class="description">
													The county has an MPESA pay bill number 646464 that
										...
										<a class="item">
											...
											<div class="content">
												...
												<div class="description">
													The service will be available from all the cybers across the county. Cyber café operators have been trained
