...
include_once("Psr\Log\LogLevel.php");
include_once("Psr\Log\LoggerInterface.php");
include_once("Psr\Log\AbstractLogger.php");
...
define('LOG_PATH', 'C:\\inetpub\\logs\\service logs\\service_logs');
